...
function preload() {
    ...
    backgroundSound = loadSound("../sounds/cinematic-dramatic-11120.mp3");
}
...
function setup() {
    ...
    objectToEat = new myImage("../images/pizza.png", 500, 400, 100, 100);
    myFont = loadFont("fonts/ProtestRiot-Regular.ttf");

    objectToEat = new myImage("../images/burnttoast.png", 500, 400, 100, 100);
    myFont = loadFont("fonts/ProtestRiot-Regular.ttf");
...
function addNewFood()
{
        ...
        objectToEat = new myImage("../images/pizza.png", random(x,y), random(w,h), 100, 100);
...
function addNewFood()
{
        ...
        objectToEat = new myImage("../images/burnttoast.png", random(x,y), random(w,h), 100, 100);
}
